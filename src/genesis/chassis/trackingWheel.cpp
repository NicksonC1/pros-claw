...
genesis::TrackingWheel::TrackingWheel(pros::adi::Encoder* encoder, float wheelDiameter, float distance,
                                     float gearRatio) {
...
genesis::TrackingWheel::TrackingWheel(pros::Rotation* encoder, float wheelDiameter, float distance, float gearRatio) {
...
genesis::TrackingWheel::TrackingWheel(pros::MotorGroup* motors, float wheelDiameter, float distance, float rpm) {
    this->motors = motors;
...
void genesis::TrackingWheel::reset() {
...
float genesis::TrackingWheel::getDistanceTraveled() {
    if (this->encoder != nullptr) {
        ...
        return genesis::avg(distances);
    } else {
        return 0;
    }
}

float genesis::TrackingWheel::getOffset() { return this->distance; }

int genesis::TrackingWheel::getType() {
