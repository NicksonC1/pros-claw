...
namespace genesis {
/**
 * @brief A base for any sink in genesis to implement.
 *
 * Sinks are genesis's abstraction for destinations that logged messages can be sent to. They are the backbone of the
...
class BaseSink {
    public:
         ...
         * <h3> Example Usage </h3>
         * @code
         * genesis::BaseSink combinedSink({genesis::telemetrySink(), genesis::infoSink()});
         ...
         * <h3> Example Usage </h3>
         * @code
         * sink.log(genesis::Level::INFO, "{} from the logger!", "Hello");
         * @endcode
    ...
    protected:
         ...
         * <h3> Example Usage </h3>
         * @code
         * infoSink()->setFormat("[genesis] -- {time} -- {level}: {Message}");
         * infoSink()->info("hello");
         * // This will be formatted as:
         * // "[genesis] -- 10 -- INFO:  hello"
         * @endcode
         */
