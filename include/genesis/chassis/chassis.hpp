...
class OdomSensors {
    public:
         ...
         * genesis::TrackingWheel vertical1(&vertical_rotation, genesis::Omniwheel::NEW_275, 0.5);
         * genesis::OdomSensors sensors(&vertical1, // vertical tracking wheel
...
class ControllerSettings {
    public:
         ...
         * @b Example
         * @code {.cpp}
         * genesis::ControllerSettings lateralSettings(10, // proportional gain (kP)
...
class Chassis {
    public:
         ...
         * @code {.cpp}
         * // set the pose of the chassis to x = 0, y = 0, theta = 0
         * genesis::Pose poseA(0, 0, 0);
         * chassis.setPose(poseA);
         * // set the pose of the chassis to x = 5.3, y = 12.2, theta = 3.14
         * // this time with theta in radians
         * genesis::Pose poseB(5.3, 12.2, 3.14);
         ...
         * genesis::Pose poseRad = chassis.getPose(true);
         * // print the x, y, and theta values of the pose
         * printf("X: %f, Y: %f, Theta: %f\n", poseRad.x, poseRad.y, poseRad.theta);
         * // get the pose of the chassis in radians and standard position
         * genesis::Pose poseRadStandard = chassis.getPose(true, true);
         * // print the x, y, and theta values of the pose
