...
class TrackingWheel {
    public:
         ...
         * genesis::TrackingWheel verticalTrackingWheel(&verticalEncoder, genesis::Omniwheel::NEW_275, -5);
         ...
         * genesis::TrackingWheel horizontalTrackingWheel(&horizontalEncoder, genesis::Omniwheel::OLD_325, -2, 5.0/3.0);
         * @endcode
         */
         ...
         * // the rpm is 360
         * genesis::TrackingWheel leftTrackingWheel(&leftMotors, genesis::Omniwheel::OLD_4, -5, 360);
         * @endcode
         */
         ...
         *
         * If you are using odometry provided by genesis, this will automatically be called when
         ...
         *     genesis::TrackingWheel exampleTrackingWheel(&exampleEncoder, genesis::Omniwheel::NEW_275, 0.5);
         ...
         *     genesis::TrackingWheel exampleTrackingWheel(&exampleRotationSensor, genesis::Omniwheel::NEW_275, 0.5);
