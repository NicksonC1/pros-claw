 ...
 * see https://www.vexforum.com/t/expo-drive-genesiss-implementation for a detailed explanation
 */
class ExpoDriveCurve : public DriveCurve {
    public:
         ...
         * genesis::ExpoDriveCurve driveCurve(5, 12, 1.132);
         * @endcode
         */
